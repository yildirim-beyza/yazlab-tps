...
{
    //This script will generate the mesh of the roof (top)
    house data;
    ...
    public void Draw(){
        ...
        if(data.roofHeight == 0f){
            //flat roof
            verts.Add(new Vector3(-data.roofOverlay, data.baseHeight+data.floorHeight*data.floors+data.floors*data.floorWidth+data.roofWidth, -data.roofOverlay)); //0
            verts.Add(new Vector3(-data.roofOverlay, data.baseHeight+data.floorHeight*data.floors+data.floors*data.floorWidth+data.roofWidth, data.roofOverlay+data.length)); //1
            verts.Add(new Vector3(data.roofOverlay+data.width, data.baseHeight+data.floorHeight*data.floors+data.floors*data.floorWidth+data.roofWidth, -data.roofOverlay)); //2
            verts.Add(new Vector3(data.roofOverlay+data.width, data.baseHeight+data.floorHeight*data.floors+data.floors*data.floorWidth+data.roofWidth, data.roofOverlay+data.length)); //3
            ...
            tris.Add(5); tris.Add(7); tris.Add(6);
            tris.Add(6); tris.Add(7); tris.Add(2);
            tris.Add(7); tris.Add(3); tris.Add(2);
            ...
            //non-flat roof edges
            verts.Add(new Vector3(-data.roofOverlay, data.baseHeight+data.floorHeight*data.floors-diff+data.floors*data.floorWidth+data.roofWidth, -data.roofOverlay)); //0
            verts.Add(new Vector3(-data.roofOverlay, data.baseHeight+data.floorHeight*data.floors-diff+data.floors*data.floorWidth+data.roofWidth, data.roofOverlay+data.length)); //1
            ...
            verts.Add(new Vector3(data.roofOverlay+data.width, data.baseHeight+data.floorHeight*data.floors-diff+data.floors*data.floorWidth+data.roofWidth, data.roofOverlay+data.length)); //3

            //non-flat roof middle (top)
            if((data.roofEndHeight == 0 || data.roofEndLength == 0)){
                verts.Add(new Vector3(data.width/2, data.baseHeight+data.floorHeight*data.floors+data.roofHeight+data.floors*data.floorWidth+data.roofWidth, -data.roofOverlay)); //4
                verts.Add(new Vector3(data.width/2, data.baseHeight+data.floorHeight*data.floors+data.roofHeight+data.floors*data.floorWidth+data.roofWidth, data.roofOverlay+data.length)); //5

                verts.Add(new Vector3(0, data.baseHeight+data.floorHeight*data.floors+data.floors*data.floorWidth+data.roofWidth, -data.roofOverlay)); //6
                verts.Add(new Vector3(0, data.baseHeight+data.floorHeight*data.floors+data.floors*data.floorWidth+data.roofWidth, data.roofOverlay+data.length)); //7
                verts.Add(new Vector3(data.width, data.baseHeight+data.floorHeight*data.floors+data.floors*data.floorWidth+data.roofWidth, -data.roofOverlay)); //8
                verts.Add(new Vector3(data.width, data.baseHeight+data.floorHeight*data.floors+data.floors*data.floorWidth+data.roofWidth, data.roofOverlay+data.length)); //9

                tris.Add(0); tris.Add(1); tris.Add(6);
                tris.Add(1); tris.Add(7); tris.Add(6);
                tris.Add(6); tris.Add(7); tris.Add(4);
                tris.Add(7); tris.Add(5); tris.Add(4);
                
                tris.Add(4); tris.Add(5); tris.Add(8);
                tris.Add(8); tris.Add(5); tris.Add(9);
                tris.Add(8); tris.Add(9); tris.Add(2);
                tris.Add(9); tris.Add(3); tris.Add(2);
                ...
                //uvs.Add(new Vector2(verts[4].z*data.roofTS, Mathf.Sqrt(Mathf.Pow(verts[4].x+data.roofOverlay, 2) + Mathf.Pow(diff+data.roofHeight, 2))*data.roofTS));
                uvs.Add(new Vector2(verts[4].z*data.roofTS, Vector3.Distance(verts[0], verts[4])*data.roofTS));
            ...
            else{// (roofheight!=0 and roofendheight!=0)
                ...
                verts.Add(new Vector3(data.width/2, data.baseHeight+data.floorHeight*data.floors+data.roofHeight+data.floors*data.floorWidth+data.roofWidth, data.roofEndLength)); //4
                verts.Add(new Vector3(data.width/2, data.baseHeight+data.floorHeight*data.floors+data.roofHeight+data.floors*data.floorWidth+data.roofWidth, data.length-data.roofEndLength)); //5

                verts.Add(new Vector3(data.width/2-prediff-lowWidth, data.baseHeight+data.floorHeight*data.floors+data.roofHeight-data.roofEndHeight-lowHeight+data.floors*data.floorWidth+data.roofWidth, -data.roofOverlay)); //6
                verts.Add(new Vector3(data.width/2-prediff-lowWidth, data.baseHeight+data.floorHeight*data.floors+data.roofHeight-data.roofEndHeight-lowHeight+data.floors*data.floorWidth+data.roofWidth, data.roofOverlay+data.length)); //7

                verts.Add(new Vector3(data.width/2+prediff+lowWidth, data.baseHeight+data.floorHeight*data.floors+data.roofHeight-data.roofEndHeight-lowHeight+data.floors*data.floorWidth+data.roofWidth, -data.roofOverlay)); //8
                verts.Add(new Vector3(data.width/2+prediff+lowWidth, data.baseHeight+data.floorHeight*data.floors+data.roofHeight-data.roofEndHeight-lowHeight+data.floors*data.floorWidth+data.roofWidth, data.roofOverlay+data.length)); //9
                //alternative for UV
                ...
                //left side
                tris.Add(0); tris.Add(1); tris.Add(7);
                tris.Add(0); tris.Add(7); tris.Add(6);
                tris.Add(6); tris.Add(7); tris.Add(5);
                tris.Add(6); tris.Add(5); tris.Add(4);
                //rigth side
                tris.Add(2); tris.Add(9); tris.Add(3);
                tris.Add(2); tris.Add(8); tris.Add(9);
                tris.Add(8); tris.Add(4); tris.Add(5);
                tris.Add(8); tris.Add(5); tris.Add(9);
                //front
                tris.Add(12); tris.Add(10); tris.Add(14);
                //back
                tris.Add(15); tris.Add(11); tris.Add(13);

                if(!data.hasFront && (rightPreCorrection == 0f && leftPreCorrection == 0f)){
                    verts[6] = new Vector3(data.width/2, data.baseHeight+data.floorHeight*data.floors+data.roofHeight+data.floors*data.floorWidth+data.roofWidth, 0);
                    verts[8] = verts[6];
                    verts[12] = verts[6];
                    verts[14] = verts[6];
                    verts[0] = new Vector3(verts[0].x, verts[0].y, 0);
                    ...
                    verts.Add(new Vector3(0, data.baseHeight+data.floorHeight*data.floors+data.floors*data.floorWidth+data.roofWidth, 0));
                    verts.Add(new Vector3(data.width, data.baseHeight+data.floorHeight*data.floors+data.floors*data.floorWidth+data.roofWidth, 0));

                    verts[0] = new Vector3(verts[0].x, verts[0].y, leftPreCorrection);
                    verts[2] = new Vector3(verts[2].x, verts[2].y, rightPreCorrection);
                    //tris
                    tris.Clear();
                    tris.Add(0); tris.Add(1); tris.Add(16);//
                    tris.Add(1); tris.Add(7); tris.Add(16);//
                    tris.Add(16); tris.Add(7); tris.Add(6);//
                    tris.Add(6); tris.Add(7); tris.Add(5);
                    tris.Add(6); tris.Add(5); tris.Add(4);
                    //rigth side
                    tris.Add(2); tris.Add(17); tris.Add(3);//
                    tris.Add(17); tris.Add(9); tris.Add(3);//
                    tris.Add(8); tris.Add(9); tris.Add(17);//
                    tris.Add(8); tris.Add(4); tris.Add(5);
                    tris.Add(8); tris.Add(5); tris.Add(9);
                    //back
                    tris.Add(15); tris.Add(11); tris.Add(13);
                ...
                if(!data.hasBack && (rightProCorrection == 0f && leftProCorrection == 0f)){
                    verts[7] = new Vector3(data.width/2, data.baseHeight+data.floorHeight*data.floors+data.roofHeight+data.floors*data.floorWidth+data.roofWidth, data.length);
                    verts[9] = verts[7];
                    verts[13] = verts[7];
                    verts[15] = verts[7];
                    verts[1] = new Vector3(verts[1].x, verts[1].y, data.length);
                    ...
                    verts[13] = verts[7];
                    verts[15] = verts[7];
                    //add 2 more and retriangulate (2 case: is it added already? (front side...))
                    ...
                    if(verts.Count > 18){
                        tris.Clear();
                        tris.Add(0); tris.Add(1); tris.Add(16);
                        tris.Add(1); tris.Add(18); tris.Add(16);
                        tris.Add(16); tris.Add(18); tris.Add(6);
                        tris.Add(18); tris.Add(7); tris.Add(6);
                        //rigth side
                        tris.Add(2); tris.Add(17); tris.Add(3);
                        tris.Add(17); tris.Add(19); tris.Add(3);
                        tris.Add(8); tris.Add(19); tris.Add(17);
                        tris.Add(8); tris.Add(9); tris.Add(19);
                    }
                    else{
                        tris.Clear();
                        tris.Add(0); tris.Add(1); tris.Add(16);//
                        tris.Add(6); tris.Add(0); tris.Add(16);//
                        tris.Add(16); tris.Add(7); tris.Add(6);//
                        tris.Add(6); tris.Add(7); tris.Add(5);
                        tris.Add(6); tris.Add(5); tris.Add(4);
                        //rigth side
                        tris.Add(2); tris.Add(17); tris.Add(3);//
                        tris.Add(17); tris.Add(2); tris.Add(8);//
                        tris.Add(8); tris.Add(9); tris.Add(17);//
                        tris.Add(8); tris.Add(4); tris.Add(5);
                        tris.Add(8); tris.Add(5); tris.Add(9);
                        //front
